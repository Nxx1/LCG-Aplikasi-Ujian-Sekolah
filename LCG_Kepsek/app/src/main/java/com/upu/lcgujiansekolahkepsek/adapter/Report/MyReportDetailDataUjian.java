...
public class MyReportDetailDataUjian extends RecyclerView.Adapter<MyReportDetailDataUjian.MyViewHolder> {

    private Context context;
    private List<SkorModel> skorModelList;


    public MyReportDetailDataUjian(Context context, List<SkorModel> skorModels) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        holder.txt_nama.setText(new StringBuilder("")
                .append(skorModelList.get(position).getNama()));
