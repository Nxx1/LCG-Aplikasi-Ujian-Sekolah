package com.upu.lcgujiansekolahadministrator.ui.DataSiswa;
...
import com.upu.lcgujiansekolahadministrator.adapter.MyDaftarSiswaAdapter;
import com.upu.lcgujiansekolahadministrator.common.Common;
import com.upu.lcgujiansekolahadministrator.model.SiswaModel;
    ...
    private void DialogForm() {
        ...
        txt_username.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (!hasFocus) {
                    DatabaseReference dbCekAkun = FirebaseDatabase.getInstance().getReference(Common.SISWA_REF).child(txt_username.getText().toString());
                    dbCekAkun.addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if(dataSnapshot.exists()){
                                Toast.makeText(DataSiswaActivity.this, "Username sudah terdaftar!\nSilahkan gunakan username lain.", Toast.LENGTH_SHORT).show();
