...
public class MyKategoriSoalAdapter extends RecyclerView.Adapter<MyKategoriSoalAdapter.MyViewHolder> {

    private Context context;
    private List<BankSoalModel> bankSoalModelList;


    public MyKategoriSoalAdapter(Context context, List<BankSoalModel> bankSoalModelList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.setListener((view, pos) -> {
            ...
            Intent intent = new Intent(context.getApplicationContext(), SoalActivity.class);
