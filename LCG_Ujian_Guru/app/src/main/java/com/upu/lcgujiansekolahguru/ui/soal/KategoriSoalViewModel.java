...
public class KategoriSoalViewModel extends ViewModel implements IKategoriSoalCallbackListener {
        ...
        categoryRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot itemSnapshot:dataSnapshot.getChildren()){
                    ...
                    bankSoalModel.setJumlahData("Jumlah Data Soal : "+String.valueOf(itemSnapshot.child("Soal").getChildrenCount()));
